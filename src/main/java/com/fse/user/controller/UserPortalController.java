...
public class UserPortalController {
    ...
    public ModelAndView showUpdate(HttpServletRequest request, HttpServletResponse response, @SessionAttribute("login") Login login) {
        User user = new User();
    ...
    public ModelAndView updateUser(HttpServletRequest request, HttpServletResponse response, @ModelAttribute("user") User user) {
        ...
        if(userService.accountUpdate(user)==0){
